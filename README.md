...
- **Asistente de diagramas Mermaid**: eliges flujo o secuencia, llenas nodos y conexiones en un formulario, ves la vista previa y Lumen escribe el bloque de código por ti. Después puedes seguir editando el código con vista previa.
